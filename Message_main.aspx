<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Message_main.aspx.cs" Inherits="WebF.Message_main" %>
		...
		<div class="wrap-contact100">
				...
				<span class="contact100-form-title">
					...
					<div class="wrap-input100 validate-input bg1" data-validate="">
						...
						<asp:Label ID="Message_header" runat="server" Text="Label"></asp:Label>
					</div>
					<div class="wrap-input100 validate-input bg1" data-validate="">
						<span class="label-input100">發表人: </span>
						<asp:Label ID="Message_name" runat="server" Text="Label"></asp:Label>
					</div>
					<div class="wrap-input100 validate-input bg1" data-validate="">
						<span class="label-input100">發表時間: </span>
						<asp:Label ID="Message_time" runat="server" Text="Label"></asp:Label>
					</div>
					<div class="wrap-input100 validate-input bg0 rs1-alert-validate" data-validate = "無內容">
						<span class="label-input100">內容: </span>	
						<asp:Label ID="Messages" runat="server" Text="Label"></asp:Label>
					</div>
					<div class="container-contact100-form-btn">
						<asp:Button ID="Replay" runat="server" OnClick="Button1_Click" Text="回應文章" class="contact100-form-btn"/> &nbsp&nbsp&nbsp
                        <asp:Button ID="BacktoMIndex" runat="server" Text="回到留言列表" class="contact100-form-btn" OnClick="BacktoMIndex_Click" />
					</div>
				<br /><br /><br />
				<div class="card mb-4">
					<div class="card-header">本篇留言回應：</div>
					<div class="card-body">
						<asp:Repeater ID="Repeater1" runat="server" >
							<ItemTemplate>
							回覆人：<asp:Label ID="who" runat="server" Text='<%# Bind("Reply_Name") %>' ></asp:Label>
							<br />
							回應內容：<asp:Label ID="replyMessages" runat="server" Text='<%# Bind("Content") %>'></asp:Label>
							<br />
							<br />
							</ItemTemplate>
						</asp:Repeater>
