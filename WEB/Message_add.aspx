<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Message_add.aspx.cs" Inherits="WebF.Message_add" %>
		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form">
				...
				<div class="wrap-input100 validate-input bg1" data-validate="">
					...
					<asp:TextBox ID="TextBox1" runat="server" required="" aria-required="true" 
                oninput="setCustomValidity('');" oninvalid="setCustomValidity('記得填寫標題')" class="input100" type="text" name="TextBox1"></asp:TextBox>
				</div>

				<div class="wrap-input100 validate-input bg1" data-validate = "">
					<span class="label-input100">Account *</span>
					<asp:TextBox ID="TextBox2" runat="server"  class="input100" type="text" name="Reply_name" placeholder=" " ></asp:TextBox>
				</div>

				<div class="wrap-input100 validate-input bg0 rs1-alert-validate" data-validate = "Please Type Your Message">
					<span class="label-input100">Message</span>					
					<asp:TextBox ID="TextBox3" runat="server" Height="258px" TextMode="MultiLine" Width="950px" class="input100" placeholder="Your message here..."></asp:TextBox>
				</div>

				<div class="container-contact100-form-btn">
					<asp:Button ID="Button1" runat="server" Text="Send Message" OnClick="Button1_Click"  class="contact100-form-btn" />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input id="Reset1" type="reset" value="Fill in again" class="contact100-form-btn"/>
					<br/>
					<br/>
				</div>
			</form>
