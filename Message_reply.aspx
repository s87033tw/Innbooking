<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Message_reply.aspx.cs" Inherits="WebF.Message_reply" %>
...
-->
					<asp:TextBox ID="Reply_header" runat="server" class="input100" type="text" name="Reply_header"></asp:TextBox>
				</div>

				<div class="wrap-input100 validate-input bg1" data-validate = "">
					<span class="label-input100">Service Agent *</span>
					
					<asp:TextBox ID="Reply_name" runat="server" class="input100" type="text" name="Reply_name" placeholder=" "></asp:TextBox>
				</div>

				<div class="wrap-input100 validate-input bg0 rs1-alert-validate" data-validate = "Please Type Your Message">
					<span class="label-input100">Message</span>
					<asp:TextBox ID="Reply_messages" runat="server" Height="258px" TextMode="MultiLine" Width="950px" class="input100" placeholder="Your message here..."></asp:TextBox>
<!--					-->
				</div>
				<div class="container-contact100-form-btn">
					<asp:Button ID="Press" runat="server" Text="Confirm Reply" OnClick="Press_Click" class="contact100-form-btn "/>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input id="Reset1" type="reset" value="reset" class="contact100-form-btn"  />
								<br />
								<br />					
